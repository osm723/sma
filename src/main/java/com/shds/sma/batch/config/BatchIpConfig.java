...
public class BatchIpConfig {
     ...
     */
    @Bean
    public RepositoryItemReader<Ip> expiredIpReader(IpRepository ipRepository) {
        RepositoryItemReader<Ip> reader = new RepositoryItemReader<>();
        reader.setRepository(ipRepository);
     ...
     */
    @Bean
    public ExpiredIpProcessor expiredIpProcessor() {
        return new ExpiredIpProcessor();
    }
     ...
     */
    @Bean
    public JpaItemWriter<Ip> expiredIpWriter() {
        JpaItemWriter<Ip> writer = new JpaItemWriter<>();
     ...
     */
    @Bean
    public Job expiredIpJob(JobListener listener) {
        return new JobBuilder("expiredIpJob", jobRepository)
